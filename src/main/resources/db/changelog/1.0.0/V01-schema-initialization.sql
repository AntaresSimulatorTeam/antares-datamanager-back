...
ALTER TABLE project_scenario ADD CONSTRAINT "scenario_fk" FOREIGN KEY (scenario_id) REFERENCES scenario (id);

ALTER TABLE project_scenario ADD CONSTRAINT "project_fk" FOREIGN KEY (project_id) REFERENCES project (id);
...
ALTER TABLE scenario_trajectory ADD CONSTRAINT "scenario_fk2" FOREIGN KEY (scenario_id) REFERENCES scenario (id);

ALTER TABLE scenario_trajectory ADD CONSTRAINT "trajectory_fk" FOREIGN KEY (trajectory_id) REFERENCES trajectory (id);
...
insert into area(id,name, x,y, r, g, b)
 values
    (1,'AT',400,-50,255,128,128),
    (2,'BE',25,-25,66,0,0),
    (3,'CH',150,-75,66,0,0);
-- changeset elazaarmou:100V1-13

  CREATE SEQUENCE area_config_sequence
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
 ...
 -- changeset elazaarmou:100V1-14
  ...
  CREATE SEQUENCE trajectory_sequence
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
