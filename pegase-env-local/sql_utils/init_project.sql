insert into pegase_db_schema.project (id, name, created_by, creation_date, description)
values
...
insert into pegase_db_schema.scenario (id, name, created_by,status,horizon,creation_date,project_id)
...
insert into pegase_db_schema.scenario_trajectory (scenario_id, trajectory_id)
values  (1, 4),
        (1, 2),
        (1, 3),
        (2, 4),
...
INSERT INTO pegase_db_schema.scenario_tags (scenario_id, tag)
values  (3, 'config'),
        (1, 'elec'),
        (3, 'antares'),
        (3, 'bilan 22'),
