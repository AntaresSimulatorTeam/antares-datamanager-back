...
class StudyGeneratorServiceImplTest {
    ...
    void callGenerateStudyService_shouldCleanupFilesOnFailure() throws IOException {
        ...
        String studyJson = "{\"study130\": {\"areas\": {\"FR02\": {\"loads\": [\"FR02_UUID1.arrow\"], \"res\": {\"solar\": {\"series\": [\"solar_pv_FR01_SolarPVutilitytracking_2026-2027.csv.uuid.arrow\"]}}}}}}";
        ...
        verify(nasFileService).deleteFile(eq("res_dir"), eq("solar_pv_FR01_SolarPVutilitytracking_2026-2027.csv.uuid.arrow"));
