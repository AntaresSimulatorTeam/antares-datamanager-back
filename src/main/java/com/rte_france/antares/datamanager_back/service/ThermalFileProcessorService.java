...
public interface ThermalFileProcessorService {
     ...
     List<ThermalCommonParameterEntity> buildThermalCommonParameterValuesList(Path path, String horizon, Integer studyId, boolean isCivilYear) throws IOException;
