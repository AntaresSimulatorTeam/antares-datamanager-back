package com.rte_france.antares.datamanager_back.service.load;
...
public interface LoadFileProcessorService {
   ...
   */
  Set<WarningMessageEntity> checkForMissingLoadByAreaFromDb(String horizon, Integer studyId, String userNni, TrajectoryEntity trajectory) throws IOException;
}
