...
class StudyMapperTest {
    ...
    @Test
    void toStudiesDto_returnsCorrectList() {
        List<StudyEntity> entities = Arrays.asList(
                StudyEntity.builder().id(1).name("Study1").status(StudyStatus.IN_PROGRESS).project(ProjectEntity.builder().name("nameProject").build()).build(),
                StudyEntity.builder().id(2).name("Study2").status(StudyStatus.IN_PROGRESS).project(ProjectEntity.builder().name("nameProject2").build()).build()
        );

        List<StudyDTO> dtos = StudyMapper.toStudiesDto(entities);
    ...
    @Test
    void toStudiesDto_returnsEmptyListForEmptyInput() {
        List<StudyEntity> entities = List.of();
